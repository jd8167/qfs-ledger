        ...
        <div className="relative max-w-5xl mx-auto pt-20 sm:pt-24 lg:pt-32 mt-[40px] px-3 sm:px-0">
          ...
          <Slide delay={0.4} yAxis={90}>
            <div className="mt-6 sm:mt-10 grid grid-cols-2 gap-2 sm:justify-center sm:space-x-6 text-sm sm:w-[50%] m-auto">
              ...
              <Link
                className="  focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 text-white font-semibold h-12 px-6 rounded-lg w-full flex items-center justify-center sm:w-auto border-solid border-2 border-sky-500 highlight-white/20 hover:bg-sky-400"
                to="Login"
              >
                Login
              </Link>
